...
if (document.getElementById("EstadC").selectedIndex == 0){
		alert("Por favor, escolha uma das opções de Estado Civil!");
		document.form1.EstadC.focus();
		return false;
	}
...
function CarregarDados(){
	...
	if (document.getElementById("EstadC").selectedIndex == 1 ){
		var estadoC = document.getElementById("solt").value;
		
	}
	else if (document.getElementById("EstadC").selectedIndex == 2){
		var estadoC = document.getElementById("casad").value;
	}
	else{
		var estadoC = null;
	}
